...
class StatusBar:
    ...
    def __init__(self, parent):
        self.label = tk.Label(
            parent, text="", font=("Arial", 10), bg="#1e1e1e", fg="#ffaa00"
        )
        self.label.pack()
...
class ChatDisplay:
    ...
    def __init__(self, parent):
        ...
        self.text_widget.tag_config(
            "user", foreground="#00ff00", font=("Arial", 11, "bold")
        )
        self.text_widget.tag_config(
            "bot", foreground="#00d9ff", font=("Arial", 11, "bold")
        )
        self.text_widget.tag_config(
            "system", foreground="#ffaa00", font=("Arial", 10, "italic")
        )
...
class InputArea:
    ...
    def __init__(self, parent, on_send, on_stop, on_continue, on_clear):
        ...
        self.send_button = self._create_button(
            "Send", "#00d9ff", "#000000", self._handle_send
        )
        self.stop_button = self._create_button("⏹ Stop", "#ff5555", "#ffffff", on_stop)
        self.continue_button = self._create_button(
            "▶ Continue", "#00ff00", "#000000", on_continue
        )
